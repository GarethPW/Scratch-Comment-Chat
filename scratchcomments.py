...
class CommentsParser(HTMLParser):
    ...
    def parse(self,data,max_comments=30,page=1,replies=True,to=1): #Parses any data given. Data must be complete.
    ...
    def parse_project(self,project_id,max_comments=30,page=1,replies=True,to=1): #Parses any data given. Data must be complete.
        ...
        return self.parse(comments,max_comments,page,replies,to)
